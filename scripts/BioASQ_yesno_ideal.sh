GPU_NUMBER="1"  #"0,1"
RUN_FILE='/home/weisi/TemporalAssessment/baselines/QA_seq2seq_factoid.py' #ideal ans of all question type can use _factoid.py the difference is in exact ans
BASE_PATH='/home/weisi/TemporalAssessment/data/BIOASQ/yesno'
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    ...
    --context_column snippets  --question_column body  --answer_column ideal_answer --do_train --do_eval --do_predict \
