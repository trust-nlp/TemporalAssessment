...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T1_T2/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
    --train_file "$BASE_PATH/seed$SPLITSEED/amzHC_T1_2007-2008_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T1_2007-2008_validation.json"\
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T1_T3/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
    --train_file "$BASE_PATH/seed$SPLITSEED/amzHC_T1_2007-2008_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T1_2007-2008_validation.json"\
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T1_T4/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
    --train_file "$BASE_PATH/seed$SPLITSEED/amzHC_T1_2007-2008_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T1_2007-2008_validation.json"\
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T2_T2/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T2_T3/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
    --train_file "$BASE_PATH/seed$SPLITSEED/amzHC_T2_2009-2010_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T2_2009-2010_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T3_2011-2012_test.json"\
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T2_T4/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
    --train_file "$BASE_PATH/seed$SPLITSEED/amzHC_T2_2009-2010_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T2_2009-2010_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T4_2013-2014_test.json"\
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T3_T3/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T3_T4/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
    --train_file "$BASE_PATH/seed$SPLITSEED/amzHC_T3_2011-2012_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T3_2011-2012_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/amzHC_T4_2013-2014_test.json"\
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/T4_T4/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    --output_dir logs/${TASK}/${MODEL_NAME}/AY_T4/split_seed${SPLITSEED}_model_seed_42_3e-5\
    --overwrite_output_dir \
