GPU_NUMBER="0,1"
DATA_PATH='/home/weisi/Temporal/mimic-top50.json'
MODEL_NAME='bionlp/bluebert_pubmed_mimic_uncased_L-24_H-1024_A-16' # bluebert
LOWER_CASE='True'
BATCH_SIZE=32
