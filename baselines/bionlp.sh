...
MODEL_NAME='t5-base' #'razent/SciFive-base-Pubmed_PMC'
BATCH_SIZE=32 #32?
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    ...
    --train_file "$BASE_PATH/seed$SPLITSEED/bionlp_T1_2014-2015_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T1_2014-2015_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T1_2014-2015_test.json"\
    --context_column context  --question_column question  --answer_column answer --do_train --do_eval --do_predict --load_best_model_at_end \
    --predict_with_generate --evaluation_strategy epoch --learning_rate 3e-5 --max_seq_length 384 --doc_stride 128 --num_train_epochs 25 \
    --per_device_train_batch_size ${BATCH_SIZE} --per_device_eval_batch_size ${BATCH_SIZE} --gradient_accumulation_steps ${ACCUMULATION_STEPS} --eval_accumulation_steps ${ACCUMULATION_STEPS}
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    ...
    --train_file "$BASE_PATH/seed$SPLITSEED/bionlp_T1_2014-2015_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T1_2014-2015_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T2_2016-2017_test.json"\
    --context_column context  --question_column question  --answer_column answer --do_train --do_eval --do_predict --load_best_model_at_end \
    --predict_with_generate --evaluation_strategy epoch --learning_rate 3e-5 --max_seq_length 384 --doc_stride 128 --num_train_epochs 25 \
    --per_device_train_batch_size ${BATCH_SIZE} --per_device_eval_batch_size ${BATCH_SIZE} --gradient_accumulation_steps ${ACCUMULATION_STEPS} --eval_accumulation_steps ${ACCUMULATION_STEPS}
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    ...
    --train_file "$BASE_PATH/seed$SPLITSEED/bionlp_T1_2014-2015_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T1_2014-2015_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T3_2018-2019_test.json"\
    --context_column context  --question_column question  --answer_column answer --do_train --do_eval --do_predict --load_best_model_at_end \
    --predict_with_generate --evaluation_strategy epoch --learning_rate 3e-5 --max_seq_length 384 --doc_stride 128 --num_train_epochs 25 \
    --per_device_train_batch_size ${BATCH_SIZE} --per_device_eval_batch_size ${BATCH_SIZE} --gradient_accumulation_steps ${ACCUMULATION_STEPS} --eval_accumulation_steps ${ACCUMULATION_STEPS}
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    ...
    --train_file "$BASE_PATH/seed$SPLITSEED/bionlp_T2_2016-2017_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T2_2016-2017_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T2_2016-2017_test.json"\
    --context_column context  --question_column question  --answer_column answer --do_train --do_eval --do_predict --load_best_model_at_end \
    --predict_with_generate --evaluation_strategy epoch --learning_rate 3e-5 --max_seq_length 384 --doc_stride 128 --num_train_epochs 25 \
    --per_device_train_batch_size ${BATCH_SIZE} --per_device_eval_batch_size ${BATCH_SIZE} --gradient_accumulation_steps ${ACCUMULATION_STEPS} --eval_accumulation_steps ${ACCUMULATION_STEPS}
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    ...
    --train_file "$BASE_PATH/seed$SPLITSEED/bionlp_T3_2018-2019_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T3_2018-2019_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T3_2018-2019_test.json"\
    --context_column context  --question_column question  --answer_column answer --do_train --do_eval --do_predict --load_best_model_at_end \
    --predict_with_generate --evaluation_strategy epoch --learning_rate 3e-5 --max_seq_length 384 --doc_stride 128 --num_train_epochs 25 \
    --per_device_train_batch_size ${BATCH_SIZE} --per_device_eval_batch_size ${BATCH_SIZE} --gradient_accumulation_steps ${ACCUMULATION_STEPS} --eval_accumulation_steps ${ACCUMULATION_STEPS}
...
CUDA_VISIBLE_DEVICES=${GPU_NUMBER} python ${RUN_FILE} --model_name_or_path ${MODEL_NAME} --seed 42\
    ...
    --train_file "$BASE_PATH/seed$SPLITSEED/bionlp_T4_2020-2021_train.json"\
    --validation_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T4_2020-2021_validation.json"\
    --test_file  "$BASE_PATH/seed$SPLITSEED/bionlp_T4_2020-2021_test.json"\
    --context_column context  --question_column question  --answer_column answer --do_train --do_eval --do_predict --load_best_model_at_end \
    --predict_with_generate --evaluation_strategy epoch --learning_rate 3e-5 --max_seq_length 384 --doc_stride 128 --num_train_epochs 25 \
    --per_device_train_batch_size ${BATCH_SIZE} --per_device_eval_batch_size ${BATCH_SIZE} --gradient_accumulation_steps ${ACCUMULATION_STEPS} --eval_accumulation_steps ${ACCUMULATION_STEPS}
