...
def main():
    ...
    def preprocess_squad_batch(
        ...
        #targets = [answer if answer is not None else "" for answer in answers]
        '''this is for structure 
            {
            "question": "can you take this internally",
            "answer": "mixed it with some water and drank"
            }
        '''
