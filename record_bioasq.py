...
out_csv_file_name = 'BioASQ_factoid_exactans_scores_t5-base_seed1.csv'
...
for option in options:
    file_path = os.path.join(base_dir, option.replace('-', '_'), 't5-base', 'split_seed1','model_seed_42_3e-5_maxanslen20', file_name)
